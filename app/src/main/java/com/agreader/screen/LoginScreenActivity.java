...
public class LoginScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                ...
                .build();
        // [END config_signin]
        googleApiClient = new GoogleApiClient.Builder(LoginScreenActivity.this)
                .enableAutoManage(this, new GoogleApiClient.OnConnectionFailedListener() {
                    @Override
                    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                        Toast.makeText(LoginScreenActivity.this, "You Have An Error", Toast.LENGTH_SHORT).show();
                    }
                })
        ...
        mRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LoginScreenActivity.this,RegisterScreen.class);
                startActivity(intent);
            }
        });
